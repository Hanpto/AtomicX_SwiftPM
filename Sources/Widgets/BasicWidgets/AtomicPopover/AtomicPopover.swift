...
public final class AtomicPopover: UIViewController {
    ...
    public struct AtomicPopoverConfig {
        ...
        public var useBlurBackdrop: Bool
        ...
        public init(
            ...
            self.useBlurBackdrop = useBlurBackdrop
    ...
    private lazy var backdropView: UIVisualEffectView = {
    ...
    private func setupBackdrop() {
        ...
        applyBackdropStyle(theme: theme)
        ...
        backdropView.contentView.addGestureRecognizer(tapGesture)
    }

    private func applyBackdropStyle(theme: Theme) {
        if configuration.useBlurBackdrop {
            backdropView.effect = UIBlurEffect(style: .systemUltraThinMaterialDark)
            backdropView.backgroundColor = .clear
            backdropView.contentView.backgroundColor = .clear
        } else {
            backdropView.effect = nil
            backdropView.backgroundColor = .clear
            backdropView.contentView.backgroundColor = theme.tokens.color.bgColorMask
        }
    }
